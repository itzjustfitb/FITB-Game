...
let Cards = [
  {
    id: 1,
    image: "../assets/netflix/netflix1.jpg",
    value: 1,
    price: 6,
  },
  {
    id: 2,
    image: "../assets/netflix/netflix2.jpg",
    value: 2,
    price: 11,
  },
  {
    id: 3,
    image: "../assets/netflix/netflix3.jpg",
    value: 3,
    price: 16,
  },
];
...
function showCard(array) {
  ...
  array.forEach((item) => {
    ...
    title_h3.textContent = item.value + " Aylıq otaq";
    let title_p = document.createElement("p");
    title_p.textContent = "1-12 Saat ərzində yüklənmə";
